    ...
    IF (POD2MAN)
      ...
      IF (GZIP)
        ...
        IF (NOT TARGET ${MANPAGE_TARGET})
          ...
          FILE (WRITE ${CPACK_INSTALL_SCRIPT_MAN_PATH} "execute_process(COMMAND \"${CMAKE_COMMAND}\" --G \"${CMAKE_GENERATOR}\" --build \"${CMAKE_CURRENT_BINARY_DIR}\" -t man WORKING_DIRECTORY \"${CMAKE_CURRENT_BINARY_DIR}\")\n")
