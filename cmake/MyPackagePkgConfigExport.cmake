...
FOREACH(_target ${_interface_link_libraries})
  IF (TARGET ${_target})
    ...
    GET_TARGET_PROPERTY(_target_version ${_target} VERSION) # Very likely -NOTFOUND
    if(NOT _target_version)
      string(REGEX REPLACE "::.*" "" _package_dependency ${_target})
      if(NOT (_package_dependency STREQUAL _target))
        set(_target_version ${@TARGET@_PACKAGE_DEPENDENCY_${_package_dependency}_VERSION}) # May be -NOTFOUND
      endif()
    endif()
